...
export default function NewSegmentPage() {
  ...
  const {
    ...
    defaultValues: {
      rules: [{ field: '', operator: '', value: '' }] as Rule[],
      ruleLogic: 'AND',
    },
  });
    ...
    <div>
      ...
      <div className="md:grid md:grid-cols-3 md:gap-6">
        <div className="md:col-span-1">
          <h3 className="text-lg font-medium leading-6 text-gray-900">New Segment</h3>
          <p className="mt-1 text-sm text-gray-500">
            Create a new customer segment using rules or natural language.
          </p>
        </div>
